...
binaries = []
hiddenimports = ['engine', 'engine.voice', 'engine.brain', 'engine.actions', 'engine.weather', 'engine.profile', 'engine.scheduler', 'engine.skills', 'pystray', 'pyttsx3', 'vosk', 'pytesseract', 'PIL._tkinter_finder', 'babel.numbers', 'dotenv']
